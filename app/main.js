...
import {Router, Route, IndexRedirect, hashHistory, browserHistory, applyRouterMiddleware} from 'react-router'
...
ReactDOM.render(
    <Provider store={store}>
        <Router history={hashHistory} render={applyRouterMiddleware(useScroll(manageScroll))}>
